...
class UniquenessBenchmark(DistributionLearningBenchmark):
    ...
    def assess_model(
        ...
        metadata = {"number_samples": self.number_samples, "number_unique": len(unique_molecules)}
...
class NoveltyBenchmark(DistributionLearningBenchmark):
    ...
    def assess_model(
        ...
        metadata = {"number_samples": self.number_samples, "number_novel": len(novel_molecules)}
