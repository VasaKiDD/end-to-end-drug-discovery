...
def __get_fingerprint(smiles):
  ...
  """
    ...
    fingerprint = AllChem.GetMorganFingerprintAsBitVect(molecule, 3, 1024)
...
def get_fingerprint(smiles):
  ...
  """
    ...
    #     molecule, 3, 1024
    # )
    fingerprint = AllChem.GetMorganFingerprint(molecule, 3)
...
def get_valid_actions(
  ...
  """
    ...
    atom_valences = {atom_type: get_atom_valences([atom_type])[0] for atom_type in atom_types}
